...
from ..core.share_archiver import ShareArchiver
from ..utils.secure_memory import SecureMemory
from ..utils.random_utils import get_enhanced_random_bytes
...
def collect_manual_shares() -> tuple:
