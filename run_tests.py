    ...
    for i, test_file in enumerate(test_files):
        try:
            ...
            if file_success:
                ...
                print_result(False, f"{test_file}: FAILED ({len(test_result.failures)} failures, {len(test_result.errors)} errors)")
        ...
        for result in detailed_results:
            if not result['success']:
                ...
                if 'exception' in result:
                    print(f"{RED}- {file_name}: Exception - {result['exception']}{RESET}")
                else:
                    print(f"{RED}- {file_name}: {result['failures']} failures, {result['errors']} errors{RESET}")
