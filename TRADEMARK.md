# Fractum trademark policy

**The code is Apache-2.0. The name is not.** This file holds the trademark and
brand terms that used to sit at the bottom of `LICENSE`.

They were moved out on 2026-08-19 for a practical reason: appending custom terms
to the Apache text makes GitHub, SPDX and every compliance scanner fail to
recognise the project as Apache-2.0, and it makes a reader in a hurry assume a
restrictive in-house licence. Both happened. The README even described the
project as proprietary and non-commercial, which it never was.

Nothing here restricts what you may do with the source code. The Apache-2.0
grant in [`LICENSE`](LICENSE) is unchanged and unconditional. What follows
...
🚫 Right to claim official endorsement or association

================================================================================

                          DETAILED TRADEMARK USAGE GUIDELINES

================================================================================

1. PERMITTED USES (NO PERMISSION REQUIRED)

   1.1 FACTUAL AND DESCRIPTIVE REFERENCES:
   ✅ "This software is based on Fractum"
   ✅ "Compatible with Fractum technology"
   ✅ "Derived from the Fractum project"
   ✅ "Uses Fractum's cryptographic implementation"
   ✅ "Integrates with Fractum shares"

   1.2 ACADEMIC AND RESEARCH:
   ✅ Research papers and academic publications
   ✅ Technical analysis and security audits
   ✅ Educational materials and tutorials
   ✅ Conference presentations and whitepapers
   ✅ Thesis work and dissertations

   1.3 JOURNALISTIC AND EDITORIAL:
   ✅ News articles about Fractum
   ✅ Product reviews and comparisons
   ✅ Technology blogs and technical discussions
   ✅ Software catalogues and directories
   ✅ Documentation of security practices

   1.4 TECHNICAL COMMUNICATION:
   ✅ Bug reports and issue discussions
   ✅ Feature requests and technical feedback  
   ✅ Community forum discussions
   ✅ Integration documentation
   ✅ API and compatibility references

   1.5 PERSONAL AND INTERNAL USE:
   ✅ Individual deployments and modifications
   ✅ Internal company use of the software
...
2. USES WE ASK YOU TO CLEAR WITH US FIRST
   ...
   🚫 Commercial services branded with "Fractum"
   🚫 Company names including "Fractum"
   🚫 Domain names containing "Fractum"
   🚫 Social media handles using "Fractum"

   2.2 OFFICIAL REPRESENTATION:
   🚫 Claiming to be "official Fractum" anything
   🚫 Implying endorsement by S.A.S.U. KATVIO
   🚫 Using official logos or branding materials
   🚫 Representing yourself as a Fractum representative
   🚫 Creating "official" documentation or tutorials

   2.3 COMMERCIAL DISTRIBUTION:
   🚫 Distributing modified software as "Fractum"
   🚫 Selling products or services under the Fractum brand
   🚫 Offering commercial "Fractum" support or consulting
   🚫 Creating commercial "Fractum" training or certification
   🚫 Bundling software with "Fractum" branding

3. GUIDELINES FOR FORKS AND DERIVATIVE WORKS

   3.1 NAMING YOUR FORK OR DERIVATIVE:
   When creating a modified version of Fractum software, you must:

   ✅ REQUIRED - Choose a completely different name
   ✅ REQUIRED - Clearly state it's based on Fractum in documentation
   ✅ REQUIRED - Include attribution to the original Fractum project
   ✅ REQUIRED - Link to the original repository: https://github.com/katvio/fractum
   ✅ RECOMMENDED - Explain how your version differs from Fractum

   3.2 ACCEPTABLE FORK NAMES:
   ✅ "SecureShare" (with "Based on Fractum" attribution)
   ✅ "CryptoSplit Pro" (with "Derived from Fractum" note)
   ✅ "[YourCompany] Secret Manager" (with "Uses Fractum technology")
   ✅ "Enterprise SSS Tool" (with "Built on Fractum framework")
   ✅ "CloudVault" (with "Fractum-compatible encryption")

   3.3 UNACCEPTABLE FORK NAMES:
   ❌ "Fractum Pro", "Fractum Enterprise", "Fractum Plus"
   ❌ "Better Fractum", "Super Fractum", "Fractum Advanced"
   ❌ "Fractum-Fork", "MyFractum", "Fractum Community"
   ...
   This derivative work is not affiliated with or endorsed by S.A.S.U. KATVIO."
...
5. ENFORCEMENT AND VIOLATION REPORTING
   ...
   • Contact us before proceeding with questionable uses
   • We provide guidance for legitimate use cases
   • Early consultation prevents problems later
   • We support community growth within appropriate bounds
...
6. DOMAIN NAMES AND ONLINE PRESENCE
   ...
   6.2 SOCIAL MEDIA AND ONLINE HANDLES:
   🚫 Social media accounts using "fractum" as the primary identifier
   🚫 Creating accounts that imply official status
   ✅ Accounts clearly identified as community, unofficial, or derivative projects
...
8. UPDATES AND MODIFICATIONS
   ...
   • Community input on trademark policy is welcome
   • Changes will be made with reasonable notice when possible

   8.2 GRANDFATHERING:
   • Existing legitimate uses may be grandfathered with appropriate attribution
   • Pre-existing community projects will be worked with cooperatively
   • Good faith efforts to comply are appreciated and considered
...
For commercial trademark licensing, partnership opportunities, or business 
development inquiries, please contact us with:
...
follows security best practices, no software is completely secure. Users should:
• Understand the security model and its limitations
...
LIABILITY LIMITATION FOR SECURITY SOFTWARE:
In addition to the Apache License disclaimers, users acknowledge that security 
software carries inherent risks. S.A.S.U. KATVIO provides no warranties 
regarding the security, fitness, or suitability for any particular security 
application. Users assume all risks associated with cryptographic operations.

FRENCH LAW JURISDICTION:
S.A.S.U. KATVIO is a French company. Trademark matters and disputes may be 
subject to French jurisdiction and applicable French and European Union law.
